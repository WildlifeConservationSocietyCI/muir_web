...
ALTER TABLE welikia_mw_element
  ALTER COLUMN automap SET NOT NULL;

-- UPDATE ELEMENT DEFINITIONS

-- fix definition mistakes in original
UPDATE welikia_mw_element
SET mw_definition = 6
WHERE id = 232;
UPDATE welikia_mw_element
SET mw_definition = 2
WHERE id > 95 AND id < 102;
...
DECLARE
  ...
  new_group_label welikia_mw_group_label%ROWTYPE;
  new_state_label welikia_mw_state_label%ROWTYPE;
  ...
  LOOP
    ...
    LOOP
      ...
      LOOP
        ...
        ELSE
          WITH ngl AS (
            INSERT INTO welikia_mw_group_label (name, notes) VALUES (g.name, g.notes)
            ON CONFLICT ON CONSTRAINT welikia_mw_group_label_name_uq DO UPDATE SET name = g.name -- don't need update but do need id to return for next step
            RETURNING *
          ) SELECT * FROM ngl INTO new_group_label;
          WITH ng AS (
            INSERT INTO welikia_mw_group (label_id, legacy_relationshiptype_id) VALUES (new_group_label.id,
                                                                                        g.relationshiptype_id)
            RETURNING *
          )
          SELECT * FROM ng INTO g_new_event_row;
      ...
      WITH nsl AS (
        INSERT INTO welikia_mw_state_label (name) VALUES (s.description)
        ON CONFLICT ON CONSTRAINT welikia_mw_state_label_name_uq DO UPDATE SET name = s.description -- don't need update but do need id to return for next step
        RETURNING *
      ) SELECT * FROM nsl INTO new_state_label;
      WITH ns AS (
        INSERT INTO welikia_mw_state (label_id, legacy_habitatstate_id) VALUES (new_state_label.id, s.habitatstate_id)
        RETURNING *
      )
      SELECT * FROM ns INTO s_new_event_row;
...
The new strength value is on a scale ranging from weak (0) -> strong (100).
...
INSERT INTO welikia_mw_interactiontype (id, name, operation) VALUES (3, 'attenuating', '(1 - (object * weight))');
...
UPDATE welikia_mw_relationship AS r
SET interactiontype_id = 2 -- requirement ? > 2
WHERE r.strengthtype_id = 1; -- enhancing

UPDATE welikia_mw_relationship AS r
SET interactiontype_id = 3 -- exclusionary - enhancing? ? > 3
...
SET name = 'weak', prob = 25
WHERE id = 0;

UPDATE welikia_mw_strengthtype
SET name = 'moderately weak', prob = 50
WHERE id = 1;

UPDATE welikia_mw_strengthtype
SET name = 'moderately strong', prob = 75
WHERE id = 2;

UPDATE welikia_mw_strengthtype
SET name = 'strong', prob = 100
WHERE id = 3;
...
INSERT INTO e_likelihood (id, name)
VALUES (2, 'likely (other season)');

INSERT INTO e_likelihood (id, name)
VALUES (3, 'probable');

INSERT INTO e_likelihood (id, name)
VALUES (4, 'probable (other season)');

INSERT INTO e_likelihood (id, name)
VALUES (5, 'possible');

INSERT INTO e_likelihood (id, name)
VALUES (6, 'remotely possible');
...
WHERE mw_likelihood = 'Likely (other season)';
...
WHERE mw_likelihood = 'Probable (other season)';

UPDATE e_species
SET historical_likelihood = 5
WHERE mw_likelihood = 'Possible';

UPDATE e_species
SET historical_likelihood = 6
WHERE mw_likelihood = 'Remotely Possible';

UPDATE e_species
SET historical_likelihood = 7
WHERE mw_likelihood = 'Unlikely';
...
UPDATE welikia_mw_element
SET description = 'tubular red flowers such as salvia and trumpet creeper'
WHERE id = 1548;
UPDATE welikia_mw_element
SET description = 'well-drained'
WHERE id = 202;
UPDATE welikia_mw_element
SET description = '>256 mm in size'
WHERE id = 172;
UPDATE welikia_mw_element
SET description = 'combination of boulders and gravel'
WHERE id = 174;
UPDATE welikia_mw_element
SET description = 'shallow'
WHERE id = 189;
UPDATE welikia_mw_element
SET description = 'poorly drained'
WHERE id = 201;
UPDATE welikia_mw_element
SET description = 'wet '
WHERE id = 204;
UPDATE welikia_mw_element
SET description = 'moist'
WHERE id = 205;
UPDATE welikia_mw_element
SET description = 'dry'
WHERE id = 206;
UPDATE welikia_mw_element
SET description = 'organic soils'
WHERE id = 215;
UPDATE welikia_mw_element
SET description = 'inorganic soils'
WHERE id = 216;
UPDATE welikia_mw_element
SET description = 'sand or gravel'
WHERE id = 134;
UPDATE welikia_mw_element
SET description = 'gently sloping'
WHERE id = 32;
UPDATE welikia_mw_element
SET description = 'vertical'
WHERE id = 33;
UPDATE welikia_mw_element
SET description = 'south-facing'
WHERE id = 38;
UPDATE welikia_mw_element
SET description = 'ravines'
WHERE id = 44;
UPDATE welikia_mw_element
SET description = 'slopes'
WHERE id = 45;
UPDATE welikia_mw_element
SET description = 'exposed'
WHERE id = 52;
UPDATE welikia_mw_element
SET description = 'sheltered'
WHERE id = 53;
UPDATE welikia_mw_element
SET description = '"subtidal": Below low tide (mean low water to 6 feet)'
WHERE id = 106;
UPDATE welikia_mw_element
SET description = '"intertidal": Littoral zone:  between low tide (mean low water) and high tide (mean high water)'
WHERE id = 107;
UPDATE welikia_mw_element
SET description = 'rough'
WHERE id = 119;
UPDATE welikia_mw_element
SET description = 'quiet waters'
WHERE id = 120;
UPDATE welikia_mw_element
SET description = 'silt or sand'
WHERE id = 133;
UPDATE welikia_mw_element
SET description = 'moderate to steep'
WHERE id = 165;
UPDATE welikia_mw_element
SET description = 'moderate to gentle'
WHERE id = 166;
UPDATE welikia_mw_element
SET description = '65-256 mm in size'
WHERE id = 171;
UPDATE welikia_mw_element
SET description = 'low terraces'
WHERE id = 260;
UPDATE welikia_mw_element
SET description = 'bluffs and headlands'
WHERE id = 258;
UPDATE welikia_mw_element
SET
  description = 'a hardwood forest with oaks (Quercus spp.) and beech (Fagus grandifolia) codominant that occurs in dry well-drained'
WHERE id = 394;
UPDATE welikia_mw_element
SET
  description = 'the siting of Lenape villages appears to be a function of topographic exposure (protection from prevailing winds)'
WHERE id = 405;
UPDATE welikia_mw_element
SET
  description = 'in general, ecological communities are a function of geomorphological feature, innundation (water depth), water salinity, soil type, climate, and disturbance regime'
WHERE id = 457;
UPDATE welikia_mw_element
SET description = 'Height of the land above mean tide. Elevation is a function of topography.'
WHERE id = 30;
UPDATE welikia_mw_element
SET
  description = 'Precipitation that falls in the form of solid water. Snowfall is a function of weather and topographic position.'
WHERE id = 14;
UPDATE welikia_mw_element
SET description = 'animal physical disturbance is trampling'
WHERE id = 334;
UPDATE welikia_mw_element
SET description = 'Precipitation that falls in the form of liquid water. Rainfall is a function of temperature.'
WHERE id = 13;

UPDATE e_species
SET name_common = 'winter squash (pumpkin)'
WHERE ide_species = 1150;
UPDATE e_species
SET name_common = 'summer squash (field pumpkin)'
WHERE ide_species = 1151;
UPDATE e_species
SET name_common = 'maize (corn)'
WHERE ide_species = 1575;
UPDATE e_species
SET name_scientific = 'Ambystoma jeffersonianum'
WHERE ide_species = 4316;
UPDATE e_species
